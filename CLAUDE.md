...
- `/proj-gen-task-prompts`: Requirements → Unambiguous task prompts (for distributed AI execution)
- `/proj-gen-standards`: Extract code patterns → Generate CODESTYLE.md → Review best practices → Migration roadmap
- `/proj-check-standards`: Check compliance → Identify violations → Generate actionable improvement tasks
